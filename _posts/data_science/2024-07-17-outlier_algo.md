...
![A two-dimensional histogram of bivariate data. Density is shown as a single-hue heatmap and the sparse cells at the edges hold the points an outlier detector flags.](/assets/images/figures/hist2d_outliers.png){: width="1561" height="649" loading="lazy"}
...
The [figure generator](https://github.com/DiogoRibeiro7/blog-reproducibility/blob/main/scripts/figures/data_science/histogram_outliers.py) in the [blog-reproducibility repository](https://github.com/DiogoRibeiro7/blog-reproducibility) reproduces this article's figure; run it with `--dry-run` to print the numbers behind the figure without writing an image.
