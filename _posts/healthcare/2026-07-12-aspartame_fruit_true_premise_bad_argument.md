...
seo_description: 'A can of diet drink yields 3 to 20 mg of methanol, a glass of fruit juice 3 to 160 mg and the body makes 300 to 600 mg a day. The comparison with fruit is relevant, and it becomes a safety argument only once the doses are written down: a simple model predicts the blood levels measured in volunteers within 10%.'
seo_type: article
excerpt: >-
  The metabolites of aspartame are chemically ordinary, and that matters. It is
  not by itself a proof of safety, because fruit also contains things that are
  toxic at a high enough dose. What completes the argument is arithmetic: how
  much methanol and phenylalanine a can delivers, beside food, the body's own
  production, the acceptable intake and the toxic dose.
summary: >-
  This essay takes the common argument that aspartame's breakdown products also
  occur in fruit, shows why it is relevant and incomplete, and then supplies the
  missing quantities: methanol by source, a kinetic prediction checked against
  dosing studies, measured intakes against the acceptable daily intake, what the
  2023 cancer classification and the largest cohort study do and do not say, and
  the one population for whom the warning on the label is essential.
keywords:
- aspartame
- fruit methanol
- phenylalanine
...
why_this_exists: >-
  ...
  substitute for dose-response evidence, and the doses are easy to compute.
evidence: >-
  The EFSA 2013 re-evaluation of aspartame and the WHO Environmental Health
  Criteria on methanol; human dosing studies of blood methanol; a study of
  methanol from fruit and from the body; two surveys of aspartame in Portuguese
  soft drinks; the IARC and JECFA evaluations of 2023; the NutriNet-Santé cohort;
  FDA and WHO guidance.
methodology: >-
  ...
  questions of dietary usefulness. Methanol by source and cans per acceptable
  intake are arithmetic on published figures; peak blood methanol is predicted
  with a one-compartment model and compared with measured values. The script and
...
- Basílio, M., Silva, L. J. G., Pereira, A. M. P. T., Pena, A., & Lino, C. M. (2020). Artificial sweeteners in non-alcoholic beverages: occurrence and exposure estimation of the Portuguese population. *Food Additives & Contaminants: Part A*, 37(12), 2040-2050. <https://doi.org/10.1080/19440049.2020.1812734>
- Debras, C., Chazelas, E., Srour, B., Druesne-Pecollo, N., Esseddik, Y., Szabo de Edelenyi, F., ... Touvier, M. (2022). Artificial sweeteners and cancer risk: results from the NutriNet-Santé population-based cohort study. *PLoS Medicine*, 19(3), e1003950. <https://doi.org/10.1371/journal.pmed.1003950>
- EFSA Panel on Food Additives and Nutrient Sources added to Food (2013). Scientific opinion on the re-evaluation of aspartame (E 951) as a food additive. *EFSA Journal*, 11(12), 3496. <https://doi.org/10.2903/j.efsa.2013.3496>
- International Agency for Research on Cancer & Joint FAO/WHO Expert Committee on Food Additives (2023). Summary of findings of the evaluation of aspartame. <https://www.iarc.who.int/wp-content/uploads/2023/07/Summary_of_findings_Aspartame.pdf>
- Joint FAO/WHO Expert Committee on Food Additives. Aspartame. <https://apps.who.int/food-additives-contaminants-jecfa-database/Home/Chemical/62>
- Lindinger, W., Taucher, J., Jordan, A., Hansel, A., & Vogel, W. (1997). Endogenous production of methanol after the consumption of fruit. *Alcoholism: Clinical and Experimental Research*, 21(5), 939-943.
- Lino, C. M., Costa, I. M., Pena, A., Ferreira, R., & Cardoso, S. M. (2008). Estimated intake of the sweeteners, acesulfame-K and aspartame, from soft drinks, soft drinks based on mineral waters and nectars for a group of Portuguese teenage students. *Food Additives & Contaminants: Part A*, 25(11), 1291-1296. <https://doi.org/10.1080/02652030802195309>
- Stegink, L. D., Brummel, M. C., McMartin, K., Martin-Amat, G., Filer, L. J., Baker, G. L., & Tephly, T. R. (1981). Blood methanol concentrations in normal adult subjects administered abuse doses of aspartame. *Journal of Toxicology and Environmental Health*, 7(2), 281-290. <https://doi.org/10.1080/15287398109529979>
- Stegink, L. D., Filer, L. J., Bell, E. F., Ziegler, E. E., & Tephly, T. R. (1989). Effect of repeated ingestion of aspartame-sweetened beverage on plasma amino acid, blood methanol, and blood formate concentrations in normal adults. *Metabolism*, 38(4), 357-363. <https://doi.org/10.1016/0026-0495(89)90125-x>
- US Food and Drug Administration. Aspartame and other sweeteners in food. <https://www.fda.gov/food/food-additives-petitions/aspartame-and-other-sweeteners-food>
- World Health Organization (1997). *Methanol*. Environmental Health Criteria 196. International Programme on Chemical Safety. <https://www.inchem.org/documents/ehc/ehc/ehc196.htm>
