---
permalink: '/mathematics/science%20policy/the_dangerous_push_towards_pratical_mathematics/'
redirect_from:
...
seo_description: A defense of pure mathematics against pressure for immediate application, and why long-term mathematical research remains essential to science, technology, and culture.
excerpt: "The pressure to justify mathematics by immediate usefulness misunderstands how mathematical progress works. Pure research needs protection precisely because its value is often invisible at the moment it is created."
summary: "This article argues that pure mathematics must remain protected inside universities, funding systems, and public research institutions. It explains why short-term utility is a poor measure of mathematical value, how abstract mathematics becomes practical over long time horizons, why applied and pure mathematics depend on each other, and what policies can preserve the research ecosystem."
keywords:
- "pure mathematics"
- "mathematical research"
- "science policy"
...
1. Bush, V. (1945). [*Science, the Endless Frontier: A Report to the President*](https://nsf-gov-resources.nsf.gov/2023-04/EndlessFrontier75th_w.pdf). United States Government Printing Office.
2. Wigner, E. P. (1960). [The unreasonable effectiveness of mathematics in the natural sciences](https://math.dartmouth.edu/~matc/MathDrama/reading/Wigner.html). *Communications on Pure and Applied Mathematics*, 13(1), 1-14.
3. Rivest, R. L., Shamir, A., & Adleman, L. (1978). [A method for obtaining digital signatures and public-key cryptosystems](https://dl.acm.org/doi/10.1145/359340.359342). *Communications of the ACM*, 21(2), 120-126.
4. Shannon, C. E. (1938). [A symbolic analysis of relay and switching circuits](https://dspace.mit.edu/handle/1721.1/11173). *Transactions of the American Institute of Electrical Engineers*, 57(12), 713-723.
...
7. Hardy, G. H. (1940). *A Mathematician's Apology*. Cambridge University Press.
8. Hamming, R. W. (1980). The unreasonable effectiveness of mathematics. *The American Mathematical Monthly*, 87(2), 81-90.
