...
Run `python assets/viz/generate_2026_evidence_articles.py` to reproduce the tables and figure. The [reproduction script](https://github.com/DiogoRibeiro7/DiogoRibeiro7.github.io/blob/master/assets/viz/generate_2026_evidence_articles.py) uses Python, NumPy, and Matplotlib; the reported calculations used NumPy 2.3.5 and Matplotlib 3.10.8.
