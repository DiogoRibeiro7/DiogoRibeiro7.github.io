---
permalink: '/science-communication/scientific_knowledge_has_a_provenance/'
title: 'Scientific Knowledge Has a Provenance'
date: '2024-06-13'
categories:
...
classes: wide
seo_title: 'Scientific Knowledge Has a Provenance'
seo_description: 'Scientific communicators do not create most of the knowledge they explain. Claims about biology, nutrition, toxicology and medicine have a provenance that should remain visible and auditable.'
seo_type: article
excerpt: >-
  A communicator may reject academic authority, but the scientific concepts,
  measurements and evidence used in a reel still came from somewhere. The
  relevant question is not who is allowed to speak. It is whether the chain
  from claim to evidence remains visible.
summary: >-
  This article examines the provenance of scientific knowledge in public
  communication. It separates legitimate criticism of academic institutions
  from dependence on research produced across universities, hospitals,
  government laboratories, industry and professional organisations. A simple
  provenance model shows why a claim becomes harder to audit each time its
  assumptions, population, uncertainty and original evidence are removed.
  The article then develops practical standards for attribution, expertise,
  citation quality, synthesis and correction.
keywords:
...
why_this_exists: >-
  Public science communication often presents established scientific concepts
  as personal knowledge while simultaneously dismissing the institutions and
  research communities that produced them. The problem is not that non-academics
  communicate science. The problem is when the provenance of a claim disappears
  while the authority of science is retained.
evidence: >-
  Philosophical work on epistemic dependence and expertise, research on trust
  and science communication, methodological literature on scientific synthesis
  and criticism, and examples of how claims are transformed as they move from
  primary evidence to public communication.
methodology: >-
  Represent a public scientific claim as the output of a chain of transformations
  from observation through analysis, synthesis and communication. Distinguish
  the provenance of a claim from the status of the speaker, then examine how
  omitted assumptions, source selection and scope changes alter what the
...
Question: Where does the scientific knowledge used in public communication come from, and what obligations follow from using it?
Claim: Scientific knowledge has a provenance. A communicator can criticise academic institutions while still depending on research produced by universities, hospitals, government laboratories, industry and professional scientific communities. If that provenance is hidden, the audience loses the ability to audit the claim.
Counterclaim: Academic status is neither necessary nor sufficient for scientific accuracy. Institutions can reproduce error, reward poor incentives and resist correction. Independent communicators can sometimes explain evidence better than credentialed specialists.
Evidence object: Epistemic-dependence literature, a formal claim-provenance chain, examples of scope inflation between source and public claim, and established work on trust, expertise and science communication.
Failure case: Treating academia as the sole source of scientific knowledge, using credentials as a substitute for evidence, or assuming that criticism of universities is itself anti-scientific.
Reader payoff: Separate institutional criticism from scientific provenance, ask where a claim came from, identify where its meaning changed, and evaluate whether a communicator has preserved the assumptions and limits of the evidence.
Exclusions: Naming or assessing individual influencers, inferring motives, defending every academic institution, and claiming that peer review guarantees truth.
-->

A person explaining physiology on social media did not discover human physiology by opening a camera.
