...
The Theil-Sen estimator is a robust slope estimator that provides a robust estimate of the slope $$\beta$$ by taking the median of the slopes between all pairs of points. It is defined as:
...
Theil-Sen is resistant to vertical contamination because the median of pairwise slopes cannot be moved arbitrarily by a small number of bad observations.

But high-leverage contamination in $x$ can still be influential. Robust regression is not one property; leverage, vertical outliers, heteroskedasticity, and heavy tails require different diagnostics.
