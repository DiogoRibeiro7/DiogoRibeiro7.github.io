...
The first step is to assess whether an outlier is due to an error or natural variability. Domain knowledge is central to this process. For instance, an unusual result in a scientific experiment could indicate a novel discovery rather than an error.
